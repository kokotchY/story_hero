...
@main.route('/stories/show/<int:story_id>')
...
@main.route('/stories/<int:story_id>/new_initial_step', methods = ['GET', 'POST'])
...
@main.route('/stories/<int:story_id>/new_step', methods = ['GET', 'POST'])
...
@main.route('/stories/<int:story_id>/start')
...
@main.route('/stories/<int:instance_id>/play')
@main.route('/stories/<int:instance_id>/play/<int:choice>')
...
@main.route('/story/<int:story_id>.dot')
...
@main.route('/story/<int:story_id>.png')
